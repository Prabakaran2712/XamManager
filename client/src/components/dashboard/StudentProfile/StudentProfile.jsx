...
const StudentProfile = () => {
  ...
  const rollNo = localStorage.getItem("rollNo") || "202099";
  ...
  const submitForm = (e) => {
    ...
    console.log("test");
    axios
      .put(`/api/studentupdate/${rollNo}`, {
        ...formData,
        deptID: department.value,
        deptName: department.label,
        password: password,
      })
      .then((res) => {
          ...
          <div className="col-md-12 border-right">
            <div className="p-3 py-5">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h4 className="text-center display-4 mx-auto">Profile</h4>
              </div>
              <form>
